...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Response> handleNotFoundException(NameValueRequireException ex) {
        Response response = Response
                .builder()
    ...
    public ResponseEntity<Response> handleNameValueRequireException(InvalidBookingStateAndDateException ex) {
        Response response = Response
                .builder()
                .status(HttpStatus.BAD_REQUEST.value())
                .message(ex.getMessage())
